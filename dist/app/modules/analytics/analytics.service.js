      ...
      const transactionAgg = yield transaction_model_1.Transaction.aggregate([
        {
          $match: {
            ...
            type: {
              $in: [
                transaction_interface_1.TRANSACTION_TYPE.BOOKING,
                transaction_interface_1.TRANSACTION_TYPE.EXTEND,
              ],
            },
          },
        },
        ...
        { $unwind: "$booking" },
        {
          $match: {
            "booking.bookingStatus":
              booking_interface_1.BOOKING_STATUS.COMPLETED, // শুধু COMPLETED
          },
        },
        {
          $addFields: {
...
const getBookingSummary = () =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    return {
      totalBookings:
        ((_a = transactionAgg[0]) === null || _a === void 0
          ? void 0
          : _a.totalBookings) || 0,

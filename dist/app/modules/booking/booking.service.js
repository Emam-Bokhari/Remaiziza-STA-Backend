  ...
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (status) {
      const statuses = status
        ...
        .filter((s) =>
          Object.values(booking_interface_1.BOOKING_STATUS)
            .map(String)
            .includes(s),
        );
      if (!statuses.length) {
    ...
    const total =
      ((_b = (_a = result.total) === null || _a === void 0 ? void 0 : _a[0]) ===
        null || _b === void 0
        ? void 0
        : _b.count) || 0;
    const targetIds = data
...
const getUserBookingsFromDB = (userId, query) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const dataWithReviewStatus = yield Promise.all(
      data.map((b) =>
        __awaiter(void 0, void 0, void 0, function* () {
          var _a, _b;
          const isExpired =
            b.bookingStatus === booking_interface_1.BOOKING_STATUS.EXPIRED;
          ...
          return Object.assign(Object.assign({}, b), {
            ...
            isOverlapping,
            isPayable:
              b.bookingStatus === booking_interface_1.BOOKING_STATUS.PENDING &&
              !isExpired &&
              !isOverlapping,
          });
        }),
...
const cancelBookingFromDB = (bookingId, actorId, actorRole) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (isUserActor && !booking.userId.equals(actorId)) {
      ...
      throw new ApiErrors_1.default(
        403,
        "Hosts can cancel only their own bookings",
      );
